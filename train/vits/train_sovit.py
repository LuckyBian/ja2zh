...
def run_sovits_training(batch_size, 
    ...
    with open("train/vits/s2.json") as f:
        data = json.load(f)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--total_epoch", type=int, default=24)
    ...
    parser.add_argument("--save_every_epoch", type=int, default=24)
