...
def open_asr(asr_inp_dir, asr_opt_dir, asr_model, asr_model_size, asr_lang):
    ...
    cmd = f'python preprocessing/asr/tools2/asr/{asr_dict[asr_model]["path"]}'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--asr_inp_dir", type=str,default="/aifs4su/data/weizhen/data/fenghuang2/denoise3")
    parser.add_argument("--asr_opt_dir", type=str,default="/home/weizhenbian/GPTSOVITSyue/features")
    ...
    parser.add_argument("--asr_lang", type=str, default="ja")
