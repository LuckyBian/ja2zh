...
def open_slice(inp, opt_root, threshold, min_length, min_interval, hop_size, max_sil_kept, _max, alpha, n_parts):
    ...
    for i_part in range(n_parts):
        cmd = f'"{sys.executable}" preprocessing/cut/tools/slice_audio.py "{inp}" "{opt_root}" {threshold} {min_length} {min_interval} {hop_size} {max_sil_kept} {_max} {alpha} {i_part} {n_parts}'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--inp", type=str,default="/data/weizhen/14")
    parser.add_argument("--opt_root", type=str, default="/data/weizhen/cut",help="切分后的子音频的输出根目录")
    parser.add_argument("--threshold", type=str, default="-34",help="音量小于这个值视作静音的备选切割点")
    parser.add_argument("--min_length", type=str,default="5000", help="每段最小多长，如果第一段太短一直和后面段连起来直到超过这个值")
